...
\address{Saratoga, CA}{}{}% optional, remove / comment the line if not wanted; the "postcode city" and "country" arguments can be omitted or provided empty
...
\section{Experience}
	\cventry{2019--Present}{Software Quality Analysis}{Waymo (via Crowdstaffing)}{Mountain View}{}{%
		\begin{itemize}%
			...
			\item Proposed and acted as lead on a broad proposal to systematize and automate large parts of the Software Quality workflow.
		\end{itemize}}
