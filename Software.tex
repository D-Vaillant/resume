...
\section{Experience}
	\cventry{2019--Present}{Software Fault Analyst}{Waymo (via Crowdstaffing)}{Mountain View}{}{%
		\begin{itemize}%
			...
			\item Provided detailed metrics on the behavioral faults of self-driving vehicles.
			\item Leveraged Python, SQL, and Pandas to present data efficiently and accurately.
			\item Created web applications which integrated multiple informational pipelines to provide useful analytics about software failures; increased quality and productivity across the entire Software Fault Analysis team.
		\end{itemize}}
...
\section{Programming Languages}
	...
	\cvitemwithcomment{Bash}{\progress{3}}{Whatever is useful at the time.}
	\cvitemwithcomment{C++}{\progress{2}}{Protobufs.}
	\cvitemwithcomment{Javascript}{\progress{2}}{jQuery.}
	\cvitemwithcomment{Ruby}{\progress{1}}{Ruby on Rails.}
...
\section{Software Proficiencies}
	...
	\cvitem{}{Highly proficient in adapting to new technologies.}
\closesection
